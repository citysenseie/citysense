    ...
    {(() => {
      ...
      return (
        <>
          ...
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#F8F1E1]/95/[0.04]">
            ...
            {category.items.map((item) => {
              ...
              return (
                <button
                  ...
                  className="group flex w-full items-center gap-3.5 border-b border-white/[0.045] py-4 text-left"
                >
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#F8F1E1]/95/[0.035]">
                    <ItemIcon
                      className="h-4 w-4"
                      style={{ color: category.accent }}
                    />
